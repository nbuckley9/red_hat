...
def missing_value_model(train,test):
    ...
    clf=RandomForestClassifier(n_estimators=100,max_features=20) #before had n_estimators=100,max_features=20
    clf.fit(X_all,y_all)
    ...
    #remaing to do: for those rows where activity id is equal, update outcome to the value generated by clf
